...
// N'inclure que des fichiers RÉELS : un 404 ici fait échouer addAll → le SW ne
// s'installe pas et les mises à jour ne se propagent jamais.
const APP_SHELL = ['/manifest.webmanifest', '/pwa-192-v3.png', '/pwa-512-v3.png'];
