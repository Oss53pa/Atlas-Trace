...
export const PROFILS: Profil[] = [
  ...
  { id: 'representant', nom: 'Entreprise d’exécution — représentant', typeEntite: 'Entreprise d’exécution', portee: 'Entité', acces: 'LIEN', invitePar: 'Maîtrise d’ouvrage',
    ...
    note: 'Point d’entrée de l’entreprise d’exécution : engage l’entité, désigne/révoque le référent et l’adjoint (mêmes personnes, même entreprise). Notifications contractuelles bloquantes uniquement (§4.1).' },
  { id: 'referent', nom: 'Entreprise d’exécution — référent', typeEntite: 'Entreprise d’exécution', portee: 'Entité (site ou lot)', acces: 'LIEN', invitePar: 'Représentant de l’entreprise',
    cartes: ['registres_jour', 'lignes_attente', 'vivier', 'demandes_badges', 'parc', 'sortie_demande', 'preavis'],
    note: 'Représentant, référent et adjoint sont trois fonctions de la MÊME entreprise d’exécution ; le référent est désigné par le représentant, pas invité séparément par la MOA.' },
