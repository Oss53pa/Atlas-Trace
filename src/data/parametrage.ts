...
export const POUVOIRS: { code: string; effet: string }[] = [
  ...
  { code: 'CONTROLER_AU_POSTE', effet: 'Scanner, autoriser, refuser' },
  { code: 'FORCER_ACCES', effet: 'Autoriser malgré un refus du système' },
  { code: 'DECLARER_MATERIEL', effet: 'Déclarer un parc de matériel' },
  ...
  { code: 'RECEPTIONNER', effet: 'Réceptionner une livraison' },
  { code: 'AUTORISER_EVACUATION', effet: 'Autoriser une évacuation de déblais' },
  { code: 'SAISIR_COMPTAGE', effet: 'Saisir un comptage physique' },
...
export const MODELES: ModeleSectoriel[] = [
  {
    ...
    roles: [
      ...
      { nom: 'Chef de poste', pouvoirs: ['CONTROLER_AU_POSTE', 'FORCER_ACCES', 'DELIVRER_BADGE', 'RECEPTIONNER'] },
  ...
  },
  {
    ...
    roles: [
      ...
      { nom: 'Responsable magasin', pouvoirs: ['VISER_MATERIEL', 'RECEPTIONNER', 'SAISIR_COMPTAGE', 'VALIDER_CRENEAU'] },
      { nom: 'Chef de poste', pouvoirs: ['CONTROLER_AU_POSTE', 'FORCER_ACCES', 'DELIVRER_BADGE'] },
      { nom: 'Agent de contrôle', pouvoirs: ['CONTROLER_AU_POSTE'] },
...
export const REFERENTIELS: Referentiel[] = [
  ...
  { cle: 'motifs', libelle: 'Motifs de refus', portee: 'Organisation', valeurs: ['Badge inconnu', 'Badge expiré', 'Badge suspendu', 'Hors liste du jour', 'Hors zone', 'Hors plage horaire', 'Déjà entré', 'Induction expirée'] },
  ...
  { cle: 'sensibles', libelle: 'Références sensibles suivies au comptage', portee: 'Site', valeurs: ['Câble cuivre', 'Carrelage', 'Robinetterie', 'Luminaires', 'Outillage électroportatif', 'Carburant', 'Ferraille'] },
];
