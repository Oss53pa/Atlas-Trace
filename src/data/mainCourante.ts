...
export const MAIN_COURANTE_INIT: Entree[] = [
  ...
  { id: 'e2', numero: 'INC-2026-014', horodatage: '31/07 07:08', agent: 'M. Koné', type: 'INCIDENT', categorie: 'FORCAGE', titre: 'Forçage d’accès — hors plage', description: 'KOUADIO I. (Bâti-Sud) forcé à l’entrée, présenté avant l’ouverture de sa plage horaire.', photo: true, gravite: 'MINEUR', statut: 'CLOS', circonstances: 'Ouvrier présenté à 06:08, avant le début de la plage horaire de son badge.', mesures: 'Accès forcé sur autorisation verbale du chef de poste, photo prise.', suites: 'Référent Bâti-Sud informé.' },
