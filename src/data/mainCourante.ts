...
export const MAIN_COURANTE_INIT: Entree[] = [
  ...
  { id: 'e4', numero: 'INC-2026-015', horodatage: '31/07 08:15', agent: 'M. Koné', type: 'INCIDENT', categorie: 'RETENUE', titre: 'Sortie matériel non couverte — retenue', description: 'Tentative de sortie de 12 bacs acier sans autorisation ni marquage. Matériel retenu.', photo: true, gravite: 'MAJEUR', statut: 'OUVERT', circonstances: 'Toiture Plus présente 12 bacs acier à la sortie, ni autorisation approuvée ni numéro de marquage (règle R1).', mesures: 'Sortie refusée, matériel retenu au poste, photos prises, chef de poste alerté.', suites: 'Consignation en attente d’arbitrage direction / entreprise.' },
