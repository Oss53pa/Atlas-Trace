-- Ajoute les véhicules autorisés au décompte du hub « Configurer mon chantier ».
...
begin
  ...
  return jsonb_build_object(
    ...
    'vehicules',   (select count(*) from public.at_vehicules_autorises where organisation_id = any(v_orgs))
  );
end;
$function$;
